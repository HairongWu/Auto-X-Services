...
- [Elágaztatás](https://github.com/HairongWu/Auto-X-Services/fork).
...
> 🚧 A környezeti változóknak meg kell egyeznie a következő [sémával](https://github.com/HairongWu/Auto-X-Services/blob/main/src/env/schema.mjs).
